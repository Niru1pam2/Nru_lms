  ...
  function handleDragEnd(event: DragEndEvent) {
      ...
      if (courseId) {
        ...
        toast.promise(reorderPromise(), {
          ...
          error: () => {
            ...
            return "Failed reorder chapters";
          },
        });
      }
    ...
    if (activeType === "lesson" && overType === "lesson") {
      ...
      if (!chapterId || chapterId !== overChapterId) {
        toast.error("Lesson moved between different chapter id not allowed");
        return;
      }
      ...
      if (chapterIndex === -1) {
        toast.error("Chapter not found for lesson");
        return;
      }
      ...
      if (oldLessonIndex === -1 || newLessonIndex === -1) {
        toast.error("Lesson not found for reordering");
        return;
      }
