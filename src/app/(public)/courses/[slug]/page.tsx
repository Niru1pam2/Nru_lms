...
import { checkIfCourseBrought } from "@/app/data/user/user-is-enrolled";
          ...
          <div className="space-y-4">
            {course.chapters.map((chapter, idx) => (
              <Collapsible key={chapter.id} defaultOpen={idx === 0}>
                <Card className="p-0 overflow-hidden border-2 transition-all duration-200 hover:shadow-md hover:bg-muted/50 gap-0">
                    ...
                    <div className="border-t bg-muted/20">
                      <div className="p-6 pt-4 space-y-3">
                        {chapter.lessons.map((lesson, idx) => (
                          ...
                          >
                            <div className="flex size-8 items-center justify-center rounded-full border-2 bg-muted border-primary/20">
              ...
              <div className="mb-6 space-y-3">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center gap-2 text-sm">
                    ...
                    <span>Access on mobile and desktops</span>
                  </li>
                  ...
                  <li className="flex items-center gap-2 text-sm">
                    ...
                    <span>Certificate of completions</span>
                  </li>
                </ul>
